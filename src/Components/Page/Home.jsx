  ...
  return (
    <div>
      ...
      >
        <Modal.Header closeButton style={{ backgroundColor: '#ffffff', color: 'black', height: '60px' }}>
          <Modal.Title id="download-modal" style={{ color: 'black', textAlign: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <p style={{ margin: '0 10px', fontSize: '20px', fontWeight: 'bold' }}>Download Go Quizzy</p>
              <img
        ...
        >
          <p style={{ fontSize: '16px', marginBottom: '20px', maxWidth: '400px', lineHeight: '1.5' }}>
            Experience the best quizzes on the go! Download the Go Quizzy app now to enjoy interactive quizzes.
          </p>
          ...
          <button
            ...
            >
              ...
              >
                ...
                <span className="button__text" style={{ fontSize: '16px' }}>Download</span>
              </button> */}
          </div>

          <p style={{ fontSize: '12px', color: '#ccc', maxWidth: '400px' }}>
            *Available on both Android and iOS platforms. Ensure your device meets the minimum system requirements.
          </p>
        </Modal.Body>
